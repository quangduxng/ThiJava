...
public class DangxuatController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		session.removeAttribute("sessionTenKH");
		session.removeAttribute("dsgiohang");
		session.removeAttribute("sessionTenDN");
		session.removeAttribute("sessionMaKH");
		session.removeAttribute("sessionTenAD");
		session.removeAttribute("sessionMaAD");
		session.removeAttribute("sessionAD");
