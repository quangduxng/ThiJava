...
public class SanPhamDao {
	public static ArrayList<SanPhamBean> getSp() {
	...
	public static ArrayList<SanPhamBean> getSanphamTheoTen(String ten) {
		DungChung dc = new DungChung();
		dc.KetNoi();
	...
	public static boolean checkMaSp(String ma) {
		DungChung dc = new DungChung();
		dc.KetNoi();
	...
	public static int themSp(String masp, String tensp,  Long soluong, Long gia, String anh,
	...
	public static int suaSp(String masp, String tensp,  Long soluong, Long gia, String anh,
			String maloai, String mota) {
		DungChung dc = new DungChung();
	...
	public static SanPhamBean getSpTheoMa(String ma) {
		DungChung dc = new DungChung();
		dc.KetNoi();
		String sql = "select * from GiaDung where masp = ?";
		try {
