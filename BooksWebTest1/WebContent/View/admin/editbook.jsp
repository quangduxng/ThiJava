...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<%
			...
			SanPhamBean sach = (SanPhamBean)request.getAttribute("sachItem");
		%>
		...
		<div class="container" style="padding-bottom: 50px">
			<div style="min-height: 78vh">
				...
				<form action="EditSach" method="post" enctype="multipart/form-data">
					...
					<input type="number" min="1" max="2000" name="soluong" id="soluong" value="<%=sach.getSoluong() %>"> <br>
					<br> <label for="image">Ảnh: </label> <br> 
					<input type="file" name="photo" id="photo"> <br> <br> <br>
					<label for="mota">Mô tả đầy đủ: </label> <br> <br>
					<textarea name="mota" value="<%=sach.getMota() %>" id="mota"></textarea>
	...
	<script>
		...
		CKEDITOR.instances.mota.setData( `<%=sach.getMota()%>` );
	</script>
